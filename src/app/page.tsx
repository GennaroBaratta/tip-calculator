...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-start">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 w-full grid sm:grid-cols-2 sm:grid-rows-3 sm:pb-2 sm:max-w-screen-sm">

        <div className="sm:row-span-3 sm:pr-8 ">

          <div className="mb-8 sm:order-0">
        ...
        <div className="sm:row-span-3 sm:order-3 bg-very-dark-cyan text-white p-8 rounded-lg sm:mb-4 sm:flex sm:flex-col sm:justify-between">
          <div>
            <div className="flex justify-between">
              ...
              <div className="text-3xl font-bold text-cyan">
                ${!!numberOfPeople && numberOfPeople > 0 ?
                  (billAmount * tipPercentage * 0.01 / numberOfPeople).toFixed(2) :
                  0}</div>
            </div>
